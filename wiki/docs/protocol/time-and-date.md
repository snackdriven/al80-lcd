...
**Key insight:** the LCD firmware displays the **raw hour value it is given** — it does not force
...
- **No AM/PM indicator** exists. `byte[10]=0x01` did not produce an AM/PM dot (03:xx displayed
